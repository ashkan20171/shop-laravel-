                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i>0211234567</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> info@samenta.ir</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{URL::to($social->social_link)}}"><i class="fa {{$social->social_icon}}"></i></a></li>
                            @endforeach
                            @endif
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{URL::to('/')}}"><img src="{{URL::to('frontend/images/home/bamilo_logo.png')}}" alt="" /></a>
                    </div>
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            @if(Session::get('customer_id') != null )
                                <li><a href="{{URL::to('/wishlist/all')}}"><i class="fa fa-star"></i> لیست علاقه مندی ها</a></li>
                                 <li><a href="{{URL::to('/cart/checkout')}}"><i class="fa fa-crosshairs"></i> تصفیه</a></li>
                               <li>
                                <a href="{{URL::to('/customer/auth')}}"><i class="fa fa-info"></i>پروفایل</a>
                               </li>
                               <li>
                                <a href="{{URL::to('/customer/logout')}}"><i class="fa fa-lock"></i>خروج</a>
                               </li>

                            @else
                            <li>
                                <a href="{{URL::to('/customer/auth')}}"><i class="fa fa-lock"></i>ورود مشتری</a>
                            </li>
                            @endif
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <form method="post" action="{{URL::to('/search/keyword/')}}" >

                        {{csrf_field()}}
                        <div class=" pull-right">
                           <input class="form-control" type="text" name="search_word" id="search_word" placeholder="جستجو ..."/>
                        </div>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{{URL::to(
                                    '/brand/'.$manufacture->manufacture_id."/".$manufacture->manufacture_name)}}"> 
